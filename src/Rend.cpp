...
// Rend.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CRendApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CRendApp
...
// El único objeto CRendApp

CRendApp theApp;


// Inicialización de CRendApp

BOOL CRendApp::InitInstance()
{
